...
docker-compose exec rtu_biz sed -i 's/3\.125\.8\.106/localhost\:8083/' /var/www/html/wp-config.php
...
docker-compose exec rtu_biz sed -i 's/localhost\:8083/3\.125\.8\.106/' /var/www/html/wp-config.php
